...
const AijiuDetail = () => {
  ...
  taro.useEffect(() => {
    const aijiuProducts = common.GiftService.getAijiuProducts();
  ...
  if (!selectedProduct) {
    return /* @__PURE__ */ taro.jsx(taro.View, { className: "aijiu-page", children: /* @__PURE__ */ taro.jsx(taro.View, { className: "loading", children: "加载中..." }) });
  }
  return /* @__PURE__ */ taro.jsx(taro.View, { className: "aijiu-page", children: showModal && /* @__PURE__ */ taro.jsx(taro.View, { className: "modal-overlay", onClick: handleCloseModal, children: /* @__PURE__ */ taro.jsxs(taro.View, { className: "modal-content", onClick: (e) => e.stopPropagation(), children: [
...
var config = {
  "navigationBarTitleText": "艾条",
  "usingComponents": {
    "comp": "../../../comp"
  }
};
Page(taro.createPageConfig(AijiuDetail, "pages/gift/aijiu/index", { root: { cn: [] } }, config || {}));
