      ...
      children: [
        ...
        /* @__PURE__ */ taro.jsxs(taro.View, { className: "order-footer", children: [
          ...
          /* @__PURE__ */ taro.jsxs(taro.View, { className: "action-buttons", children: [
            ...
            (order.displayStatus || order.paymentStatus) === "paid" && /* @__PURE__ */ taro.jsx(taro.View, { className: "button cancel", onClick: (e) => handleCancelOrder(e, order), children: "取消订单" }),
            (order.displayStatus || order.paymentStatus) === "serving" && null,
            ["completed", "cancelled", "refunded"].includes(order.displayStatus || order.paymentStatus) && /* @__PURE__ */ taro.jsx(taro.View, { className: "button rebook", onClick: (e) => handleRebookOrder(e), children: "再次预约" })
          ] })
        ] })
      ]
    },
